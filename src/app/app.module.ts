...
@NgModule({
  declarations: [
    ...
    //NEW
    PulsePage, PulseDetailPage, SurgeryDetailPage, CodeDetails, CodeSearch, BillingDetails,
    MessageListPage, MessageDetailPage, MessageReplyModal, MessageReponseComponent,
    CalendarPage,
    SimpleFormPage,
    HomePage,ArrayFilterPipe
  ],
  imports: [
    BrowserModule,
    HttpModule,
