...
var app = {
  ...
  bindEvents: function() {
    ...
    document
      .getElementById("trackSingleEvent")
    ...
    document
      .getElementById("trackTimedEvent")
      .addEventListener("click", function() {
        ...
        setTimeout(function() {
          var eventData = {
            ButtonId: "trackTimedEvent",
            Timestamp: new Date(),
            TrackedTimeout: timeout
          };
    ...
    document
      .getElementById("slide-menu-button")
  ...
  log: function(message, isError) {
    ...
    if (app.logArea) {
      ...
      appInsights.trackTrace(message, {
        Verbosity: isError ? "error" : "verbose",
        Timestamp: timestamp
      });
    }
  },
